 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="sidebar-brand brand-logo  text-light" href="/">Fairaro</a>
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="/">
          ...
          <span class="menu-title">Teacher Dash</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/teacher/lectures">All Lecture</a></li>
            <li class="nav-item"> <a class="nav-link" href="/teacher/ulectures">Upcoming Lecture</a></li>
            <li class="nav-item"> <a class="nav-link" href="/teacher/clectures">Completed Lecture</a></li>
            <li class="nav-item"> <a class="nav-link" href="/teacher/olectures">Ongoing Lecture</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basics">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="/teacher/tasks">All Tasks</a></li>
            <li class="nav-item"> <a class="nav-link" href="/teacher/tasksubmissions">Tasks Submissions</a></li>
          </ul>
        </div>
      </li>
      
      <li class="nav-item menu-items">
        <a class="nav-link" href="/teacher/enrolled">
          <span class="menu-icon">
            <i class="mdi mdi-speedometer"></i>
          </span>
