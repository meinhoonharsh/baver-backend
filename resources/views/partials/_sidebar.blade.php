 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
      <a class="sidebar-brand brand-logo  text-light" href="/">TNP WorkShop</a>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="#">Ongoing Workshop</a></li>
            <li class="nav-item"> <a class="nav-link" href="#">Enrolled Workshop</a></li>
            <li class="nav-item"> <a class="nav-link" href="#">Upcoming Workshop</a></li>
            <li class="nav-item"> <a class="nav-link" href="#">Attended Workshop</a></li>
            <li class="nav-item"> <a class="nav-link" href="#">Completed Workshop</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item menu-items">
