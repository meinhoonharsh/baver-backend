...
@section('content')
    <div class="row">
        ...
        <?php
        $analytics = [['Enrolled', 'success'], ['Upcoming', 'primary'], ['Attended', 'danger'], ['Attended', 'info']];
        ?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @foreach ($attendancerecords as $attendance)
                        <div
                            class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-1">
    ...
    <div class="row">
        <?php
        $workshops = [['Enrolled', 'success'], ['Upcoming', 'primary'], ['Attended', 'danger']];
        ?>
